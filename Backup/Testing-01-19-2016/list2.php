...
function getserviceslist($log, $location, $categoryid = null, $massaid = null, $pagenum = null)
{
    ...
    if ($categoryid != null && $massaid == null) {
        ...
        if ($pagenum != null) {
            ...
            $joinquery = DBformquery_join(array("a.serviceid", "a.name as servicename", "a.price", "b.name as shopname", "b.pic", "b.latitude", "b.longtitude"), "({$query2}) as a", "join", "({$query1}) as b", "a.shopid = b.shopid", "limit " . $start . "," . $perpagenum_services);
            ...
            $joinquery = DBformquery_join(array("a.serviceid", "a.name as servicename", "a.price", "b.name as shopname", "b.pic", "b.latitude", "b.longtitude"), "({$query2}) as a", "join", "({$query1}) as b", "a.shopid = b.shopid");
        ...
        if ($pagenum != null) {
            ...
            $joinquery = DBformquery_join(array("a.serviceid", "a.name as servicename", "a.price", "b.name as shopname", "b.pic", "b.latitude", "b.longtitude"), "Service a", "join", "({$query1}) as b", "a.shopid = b.shopid", "limit " . $start . "," . $perpagenum_services);
        ...
        {
            $joinquery = DBformquery_join(array("a.serviceid", "a.name as servicename", "a.price", "b.name as shopname", "b.pic", "b.latitude", "b.longtitude"), "Service a", "join", "({$query1}) as b", "a.shopid = b.shopid");
        }
